...
:wsjt-devel: https://sourceforge.net/projects/wsjt-x-improved/lists/wsjt-x-improved-community/[join the group]
:wsjt-devel2: https://sourceforge.net/projects/wsjt-x-improved/lists/wsjt-x-improved-community/[subscribe to the list]
