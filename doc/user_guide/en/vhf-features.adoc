...
Two new controls have been added to the Astro Window.  A spinbox allows 
entry of the amount the TX frequency is shifted from the receive frequency
in MHz.  An adjacent checkbox allows this feature to be enabled.
