...
during a QSO. These options can be activated on the *Decode* menu.
...
QSOs between countries with spectral allocations at 2304 and 2320
MHz. Set the desired Tx shift (an integer number of MHz) at bottom of
the *Astronomical Data* window, and check the *Enable* box.
