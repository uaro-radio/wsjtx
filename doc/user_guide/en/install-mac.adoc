For *macOS 10.15* and later installers are provided for x86_64 (Intel)
systems and for ARM64 (Apple silicon) systems. Download the correct
package for your system from the {downloads}, double-click on the file name, and follow the
on-screen prompts in the Installer app. Double-click and consult the
`ReadMe` file for important installation notes.
