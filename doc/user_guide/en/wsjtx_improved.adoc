...
The *Monitor* button turns yellow if audio file saving has been selected from the *Save* tab.
...
A second set of band buttons is available for operations on the VHF / UHF / SHF bands. Switching is done via the "VHF / UHF Buttons" option in the View menu.

image::bandbutton3.png[align="center",alt="bandbutton3"]
