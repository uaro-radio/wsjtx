...
_WSJT-X_ will be one of these email lists: {wsjt-devel} or
{wsjtx_group}. The chances are good that someone with similar
interests and equipment has already solved your problem and will be
happy to help.  To post messages in any of these forums you will need
to join the group.
