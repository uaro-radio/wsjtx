...
To send a message, select the appropriate tab and then the a band,
...
activated autonatically, and your message will be sent to the callsign
...
To receive these special mesages, select *Enable Message Popups* on the 
*View* menu:
